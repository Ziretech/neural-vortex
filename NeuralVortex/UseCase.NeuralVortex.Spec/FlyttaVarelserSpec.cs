...
namespace UseCase.NeuralVortex.Spec
{
    ...
    public class FlyttaVarelserSpec
    {
        ...
        public void Flytta_huvudkaraktären_uppåt()
        {
            ...
            spelvärld.Huvudkaraktär.Returns(new Huvudkaraktär { Position = new Spelvärldsposition(0, 0) });
        ...
        {
            var spelvärld = Substitute.For<ISpelvärld>();
            spelvärld.Huvudkaraktär.Returns(new Huvudkaraktär { Position = new Spelvärldsposition(2, 3) });
            var flyttaVarelser = new FlyttaVarelser(spelvärld, null);
        ...
        {
            var spelvärld = Substitute.For<ISpelvärld>();
            spelvärld.Huvudkaraktär.Returns(new Huvudkaraktär { Position = new Spelvärldsposition(2, 13) });
            var flyttaVarelser = new FlyttaVarelser(spelvärld, null);
        ...
        {
            var spelvärld = Substitute.For<ISpelvärld>();
            spelvärld.Huvudkaraktär.Returns(new Huvudkaraktär { Position = new Spelvärldsposition(1, 13) });
        ...
        {
            var spelvärld = Substitute.For<ISpelvärld>();
            spelvärld.Huvudkaraktär.Returns(new Huvudkaraktär { Position = new Spelvärldsposition(13, 1) });
            var hinderkarta = Substitute.For<IHinderkarta>();
